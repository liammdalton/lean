...
name const & get_inv_ne_zero_name();
...
name const & get_linear_ordered_field_name();
...
name const & get_numeral_add_congr_name();
name const & get_numeral_bit0_add_bit0_name();
name const & get_numeral_one_add_one_name();
name const & get_numeral_one_add_bit0_name();
name const & get_numeral_bit0_add_one_name();
name const & get_numeral_bit1_add_one_name();
name const & get_numeral_one_add_bit1_name();
name const & get_numeral_bit0_add_bit1_name();
name const & get_numeral_bit1_add_bit0_name();
name const & get_numeral_bit1_add_bit1_name();
name const & get_numeral_inv_simp_one_name();
name const & get_numeral_inv_simp_inv_name();
name const & get_numeral_inv_simp_name();
name const & get_numeral_inv_simp_mulinv_name();
name const & get_numeral_neg_congr_name();
name const & get_numeral_neg_add_neg_name();
name const & get_numeral_neg_add_pos_eq_neg_name();
name const & get_numeral_neg_add_pos_eq_pos_name();
name const & get_numeral_pos_add_neg_eq_neg_name();
name const & get_numeral_pos_add_neg_eq_pos_name();
name const & get_numeral_mul_congr_name();
name const & get_numeral_neg_eq_zero_name();
name const & get_numeral_neg_eq_pos_name();
name const & get_numeral_neg_eq_neg_name();
name const & get_numeral_neg_mul_neg_name();
name const & get_numeral_neg_mul_pos_name();
name const & get_numeral_pos_mul_neg_name();
name const & get_numeral_mul_bit0_name();
name const & get_numeral_mul_bit1_name();
name const & get_numeral_mul_inv_eq_inv_name();
name const & get_numeral_mul_inv_eq_noninv_name();
name const & get_numeral_mulinv_add_name();
name const & get_numeral_add_mulinv_name();
name const & get_numeral_inv_add_name();
name const & get_numeral_add_inv_name();
name const & get_numeral_mul_inv_name();
name const & get_numeral_mul_inv_int_name();
name const & get_numeral_inv_mul_inv_name();
name const & get_numeral_inv_mul_comm_name();
name const & get_numeral_mulinv_mul_name();
name const & get_numeral_mul_mulinv_name();
name const & get_numeral_mulinv_eq_int_name();
name const & get_numeral_mulinv_eq_mulinv_name();
name const & get_numeral_inv_neg_eq_neg_inv_name();
name const & get_numeral_pos_bit0_name();
name const & get_numeral_pos_bit1_name();
name const & get_numeral_mulinv_ne_zero_of_ne_zero_ne_zero_name();
...
name const & get_ordered_ring_name();
name const & get_ordered_semiring_name();
name const & get_ordered_arith_nonzero_of_pos_name();
name const & get_ordered_arith_nonzero_of_neg_name();
name const & get_ordered_arith_zero_not_lt_zero_name();
name const & get_ordered_arith_zero_not_le_neg_name();
name const & get_ordered_arith_zero_not_lt_neg_name();
name const & get_ordered_arith_lt_of_zero_lt_name();
name const & get_ordered_arith_le_of_zero_le_name();
name const & get_ordered_arith_eq_of_zero_le1_name();
name const & get_ordered_arith_eq_of_zero_le2_name();
name const & get_ordered_arith_mulinv_pos_of_pos_pos_name();
name const & get_ordered_arith_resolve_lt_lt_name();
name const & get_ordered_arith_resolve_lt_le_name();
name const & get_ordered_arith_resolve_le_lt_name();
name const & get_ordered_arith_resolve_le_le_name();
