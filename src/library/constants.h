...
name const & get_lean_syntax_expr_name();
name const & get_lean_syntax_expr_const_name();
name const & get_lean_syntax_expr_loc_name();
name const & get_lean_syntax_expr_var_name();
name const & get_lean_syntax_expr_meta_name();
name const & get_lean_syntax_expr_sort_name();
name const & get_lean_syntax_expr_pi_name();
name const & get_lean_syntax_expr_lam_name();
name const & get_lean_syntax_expr_app_name();
name const & get_lean_syntax_expr_elet_name();
...
name const & get_lean_syntax_level_name();
name const & get_lean_syntax_level_meta_name();
name const & get_lean_syntax_level_zero_name();
name const & get_lean_syntax_level_succ_name();
name const & get_lean_syntax_level_max_name();
name const & get_lean_syntax_level_imax_name();
name const & get_lean_syntax_level_param_name();
name const & get_lean_syntax_level_global_name();
...
name const & get_lean_name_sing_name();
name const & get_lean_name_cons_name();
...
name const & get_tactic_reflect_name();
