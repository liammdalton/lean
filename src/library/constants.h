...
name const & get_ordered_arith_pos_bit0_name();
name const & get_ordered_arith_pos_bit1_name();
name const & get_ordered_arith_zero_lt_one_name();
name const & get_ordered_arith_pos_of_pos_of_mulinv_pos_name();
