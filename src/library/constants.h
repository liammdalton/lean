...
name const & get_expr_const_name();
name const & get_expr_app_name();
name const & get_expr_lam_name();
name const & get_expr_pi_name();
name const & get_expr_sort_name();
...
name const & get_name_nil_name();
name const & get_name_cons_name();
