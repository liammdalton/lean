...
name const & get_lean_expr_const_name();
name const & get_lean_expr_var_name();
name const & get_lean_expr_sort_name();
name const & get_lean_expr_pi_name();
name const & get_lean_expr_lam_name();
name const & get_lean_expr_app_name();
name const & get_lean_expr_elet_name();
...
name const & get_lean_level_zero_name();
name const & get_lean_level_succ_name();
name const & get_lean_level_max_name();
name const & get_lean_level_imax_name();
name const & get_lean_level_param_name();
name const & get_lean_level_global_name();
...
name const & get_lean_name_nil_name();
